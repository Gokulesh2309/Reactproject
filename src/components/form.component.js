...
export default class Form extends Component {
    ...
    formObject = event => {
        ...
        switch (name) {
            ...
            case "contact":
                error.contact =
                    value.length < 10 ? "contact should 10 digits long" : "";
                break;
            case "Address":
                error.Address =
                    value.length<10 ? "Address must be atleast 10 characters long" : "";
            default:
                break;
        }
                    ...
                    <form className="card-body" onSubmit={this.onFormSubmit}>
                        ...
                        <div className="form-group mb-3">
                            ...
                            <input
                                ...
                                type="number"
                                name="contact"
                                className={error.contact.length > 0 ? "is-invalid form-control" : "form-control"}
                                onChange={this.formObject}/>
